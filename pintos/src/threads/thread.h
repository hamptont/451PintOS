...
struct thread
  {
    ...
    struct list lock_list;        /*list of locks this thread currently holds*/
...
void thread_set_priority_donated(struct thread *blocker_t, int priority);
void thread_set_effective_priority (int);
